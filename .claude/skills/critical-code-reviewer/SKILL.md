...
When reviewing changes, always read the full file — not just the diff. Diffs hide surrounding context that may reveal bugs, inconsistencies, or missed opportunities.
